...
namespace BovineLabs.Basics.Tests.Extensions
{
    ...
    {
        /// <summary> Tests <see cref="Basics.Extensions.ListExtensions.AddRangeNative{T}(System.Collections.Generic.List{T},Unity.Collections.NativeArray{T})"/>. </summary>
        [Test]
        ...
        /// <summary> Tests <see cref="Basics.Extensions.ListExtensions.AddRangeNative{T}(System.Collections.Generic.List{T},Unity.Collections.NativeArray{T},int)"/>. </summary>
        [Test]
        ...
        /// <summary> Tests <see cref="Basics.Extensions.ListExtensions.AddRangeNative{T}(System.Collections.Generic.List{T},Unity.Collections.NativeSlice{T})"/>. </summary>
        [Test]
