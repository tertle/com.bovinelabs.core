// <copyright file="PauseNetCodeSystem.cs" company="BovineLabs">
//     Copyright (c) BovineLabs. All rights reserved.
// </copyright>

#if !BL_DISABLE_PAUSE && UNITY_NETCODE
namespace BovineLabs.Core.Pause
{
    ...
    [WorldSystemFilter(WorldSystemFilterFlags.ThinClientSimulation | WorldSystemFilterFlags.ServerSimulation | WorldSystemFilterFlags.ClientSimulation)]
    public partial struct PauseNetCodeSystem : ISystem, ISystemStartStop
    {
