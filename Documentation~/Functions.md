...
```csharp
  ...
  {
      private Functions<InstantiateData> instantiateFunctions;
      ...
      {
          public Functions<InstantiateData> InstantiateFunctions;
          ...
          private void Execute(Entity entity, in Spawner spawner, in LocalTransform localTransform)
          {
              ...
              {
                  if (this.InstantiateFunctions.Execute(i, ref data) != 0)
                  {
...
public unsafe struct InstantiateTestUnit : IFunction<ExampleSystem.JobData>
{
    ...
    private int Execute(ref ExampleSystem.JobData data)
    {
    ...
    {
        return ((InstantiateTestUnit*)target)->Execute(ref UnsafeUtility.AsRef<ExampleSystem.JobData>(data));
    }
}
```
