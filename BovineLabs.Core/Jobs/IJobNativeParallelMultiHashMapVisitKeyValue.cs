// <copyright file="IJobNativeParallelMultiHashMapVisitKeyValue.cs" company="BovineLabs">
...
namespace BovineLabs.Core.Jobs
{
    ...
    [JobProducerType(typeof(JobNativeParallelMultiHashMapVisitKeyValue.JobNativeParallelMultiHashMapVisitKeyValueProducer<,,>))]
    [SuppressMessage("ReSharper", "TypeParameterCanBeVariant", Justification = "Strict requirements for compiler")]
    public interface IJobNativeParallelMultiHashMapVisitKeyValue<TKey, TValue>
    ...
    /// <summary> Extension methods for <see cref="IJobNativeParallelMultiHashMapVisitKeyValue{TKey,TValue}" />. </summary>
    public static class JobNativeParallelMultiHashMapVisitKeyValue
    {
        /// <summary> Schedule a <see cref="IJobNativeParallelMultiHashMapVisitKeyValue{TKey,TValue}" /> job. </summary>
        ...
        public static unsafe JobHandle ScheduleParallel<TJob, TKey, TValue>(
            ...
            where TJob : struct, IJobNativeParallelMultiHashMapVisitKeyValue<TKey, TValue>
            where TKey : struct, IEquatable<TKey>
            where TValue : struct
        {
            var jobProducer = new JobNativeParallelMultiHashMapVisitKeyValueProducer<TJob, TKey, TValue>
            {
                HashMap = hashMap,
                JobData = jobData,
            };
            ...
            var scheduleParams = new JobsUtility.JobScheduleParameters(
                ...
                JobNativeParallelMultiHashMapVisitKeyValueProducer<TJob, TKey, TValue>.Initialize(),
                dependsOn,
        ...
        /// <typeparam name="TKey"> The type of the key in the hash map. </typeparam>
        /// <typeparam name="TValue"> The type of the value in the hash map. </typeparam>
        internal struct JobNativeParallelMultiHashMapVisitKeyValueProducer<TJob, TKey, TValue>
            where TJob : struct, IJobNativeParallelMultiHashMapVisitKeyValue<TKey, TValue>
            where TKey : struct, IEquatable<TKey>
            where TValue : struct
        {
            ...
            private delegate void ExecuteJobFunction(
                ref JobNativeParallelMultiHashMapVisitKeyValueProducer<TJob, TKey, TValue> producer,
            ...
            internal static IntPtr Initialize()
            {
                if (jobReflectionData == IntPtr.Zero)
                {
                    jobReflectionData = JobsUtility.CreateJobReflectionData(
                        typeof(JobNativeParallelMultiHashMapVisitKeyValueProducer<TJob, TKey, TValue>),
                        typeof(TJob),
            ...
            internal static unsafe void Execute(
                ref JobNativeParallelMultiHashMapVisitKeyValueProducer<TJob, TKey, TValue> fullData,
                IntPtr additionalPtr,
                IntPtr bufferRangePatchData,
                ref JobRanges ranges,
                int jobIndex)
