...
namespace BovineLabs.Core.Collections
{
    ...
    public static unsafe class UnsafeThreadStreamEx
    {
        ...
        public static void WriteLarge<T>(this ref UnsafeThreadStream.Writer writer, NativeArray<T> array)
            where T : unmanaged
        {
        ...
        public static void WriteLarge<T>(this ref UnsafeThreadStream.Writer writer, NativeSlice<T> data)
            where T : unmanaged
        {
        ...
        public static void WriteLarge(this ref UnsafeThreadStream.Writer writer, byte* data, int size)
        {
        ...
        public static void ReadLarge(this ref UnsafeThreadStream.Reader reader, byte* buffer, int size)
        {
            var allocationCount = size / MaxSize;
            var allocationRemainder = size % MaxSize;
        ...
        public static void ReadLarge<T>(this ref UnsafeThreadStream.Reader reader, byte* buffer, int length)
            where T : unmanaged
        {
