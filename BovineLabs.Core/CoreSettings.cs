namespace BovineLabs.Core
{
    ...
    public sealed class CoreSettings : SettingsSingleton<CoreSettings>
    {
        ...
        private bool _includeInReleaseBuild;

        public StyleSheet ThemeStyleSheet => _themeStyleSheet;

        public bool IncludeInReleaseBuild => _includeInReleaseBuild;

#if UNITY_EDITOR
        private void Reset()
        {
            _themeStyleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>(
