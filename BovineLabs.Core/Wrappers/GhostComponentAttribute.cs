...
namespace Unity.NetCode
{
    ...
    public class GhostComponentAttribute : Attribute
    {
        ...
        {
            this.PrefabType = GhostPrefabType.All;
            this.OwnerPredictedSendType = GhostSendType.All;
            this.OwnerSendType = SendToOwnerType.All;
            this.SendDataForChildEntity = true;
        }
