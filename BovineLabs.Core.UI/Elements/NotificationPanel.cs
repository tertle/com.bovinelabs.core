    ...
    public partial class NotificationPanel : BindableElement
    {
        ...
        public bool accepted
        {
            ...
            set
            {
                ...
                {
                    this.NotifyPropertyChanged(nameof(this.accepted));
        ...
        public bool cancelled
        {
            ...
            set
            {
                ...
                {
                    this.NotifyPropertyChanged(nameof(this.cancelled));
        ...
        public bool notificationVisible
        {
            ...
            set
            {
                ...
                this.NotifyPropertyChanged(nameof(this.notificationVisible));
            }
        }
        ...
        public string acceptLabel
        {
            ...
            set
            {
                ...
                this.NotifyPropertyChanged(nameof(this.acceptLabel));
            }
        }
        ...
        public string cancelLabel
        {
            ...
            set
            {
                ...
                this.NotifyPropertyChanged(nameof(this.cancelLabel));
            }
        }
